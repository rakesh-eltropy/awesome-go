...
- [oauthgo](https://github.com/zekith/oauthgo) - oauthgo is a lightweight Go library for OAuth2 and OIDC, offering built-in provider support, secure session handling, and strong defenses like PKCE and nonce validation — all while staying modular and framework-agnostic.
